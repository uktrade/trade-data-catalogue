...
class TestDatasetDataPreviewModel(TestCase):
    ...
    def test_object_initialises_with_table_type(self, MockDatasetTable):
        ...
        mock_valid_dataset_data_preview_instance = DatasetDataPreview("mock-dataset", "v1.0.0", "table", "mock-table")
        mock_table_instance.dataset = mock_valid_dataset_data_preview_instance


        self.assertEqual(mock_valid_dataset_data_preview_instance.data_object, mock_table_instance)
    ...
    def test_object_initialises_with_report_type(self, MockDatasetReport):
        ...
        mock_valid_dataset_data_preview_instance = DatasetDataPreview("mock-dataset", "v1.0.0", "report", "mock-report")
        mock_report_instance.dataset = mock_valid_dataset_data_preview_instance


        self.assertEqual(mock_valid_dataset_data_preview_instance.data_object, mock_report_instance)
